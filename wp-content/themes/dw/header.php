    ...
    <header role="banner" aria-label="En-tête du site">
        <div class="header__logo-container">
            <nav class="header__nav" role="navigation" aria-label="Menu principal">
                <a href="http://portfolio.test/" aria-label="Retour à l’accueil" itemprop="url">
                ...
                <input type="checkbox" id="menu-toggle" class="nav__toggle" aria-controls="main-menu"
                       aria-expanded="false"/>
                <label for="menu-toggle" class="nav__toggle-label">
                ...
                <div id="main-menu" class="nav__menu" role="menu">
                    <?php
                    $links = dw_get_navigation_links('header');
                    foreach ($links as $link):?>
                        <a class="nav__link" href="<?= esc_url($link->href) ?>" role="menuitem" itemprop="url">
                            <?= esc_html($link->label) ?>
                        </a>
                    <?php endforeach; ?>
                </div>
